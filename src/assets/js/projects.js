...
export const dev_projects = [
  {
    title: "Dream-Ease",
    description:
      "Sleep health dashboard built with Angular using global sleep statistics stored on a Firebase database.",
    imgUrl: projImg1,
    deployedUrl: "https://robertopatino1.github.io/Sleep-Health-Calculator/",
    repositoryUrl: "https://github.com/RobertoPatino1/Sleep-Health-Calculator",
  },
  {
    title: "Clima-Track",
    description:
      "Climate dashboard that interfaces with weather and location APIs, delivering insights through dynamic data visualization using ChartJS",
    imgUrl: projImg2,
    deployedUrl: "https://robertopatino1.github.io/ClimaTrack/",
    repositoryUrl: "https://github.com/RobertoPatino1/ClimaTrack",
  },
  {
    title: "Developer Calculator",
    description:
      "A simple calculator that estimates payments for a development project",
    imgUrl: projImg3,
    deployedUrl: "https://robertopatino1.github.io/DeveloperCalculator/",
    repositoryUrl: "https://github.com/RobertoPatino1/DeveloperCalculator",
  },
  {
...
export const low_level_projects = [
  {
    title: "3NCRYPT0R",
    description:
